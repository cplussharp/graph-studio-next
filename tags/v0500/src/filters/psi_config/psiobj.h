    ...
    public MPEG2_PSI_SECTION
{
                        ...
                        )
    {
        ...
        DumpTrace1(TEXT("pat version # = %d\n"), version_number);

        // pat specific fields
        transport_stream_id         =   PAT_TRANSPORT_STREAM_ID_VALUE       (pbBuf) ;
        DumpTrace1(TEXT("transport_stream_id = %d\n"), transport_stream_id);
        ...
        for(int i=0; i< number_of_programs ; i++)
        {
            ...
            DumpTrace1(TEXT("    program index               = %d\n"), i);
            DumpTrace1(TEXT("    program_number              = %d\n"), program_descriptor[i].program_number);
            DumpTrace1(TEXT("    network_or_program_map_PID  = %d\n\n"), program_descriptor[i].network_or_program_map_PID);
        } 
