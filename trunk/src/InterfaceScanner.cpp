...
const CInterfaceInfo CInterfaceScanner::m_knownInterfaces[] = 
{
    ...
    CInterfaceInfo(TEXT("{DDF15B12-BD25-11D2-9CA0-00C04F7971E0}"), TEXT("IBDA_AutoDemodulate"), TEXT("bdaiface.h"), TEXT("")),
    CInterfaceInfo(TEXT("{FD0A5AF3-B41D-11D2-9C95-00C04F7971E0}"), TEXT("IBDA_DeviceControl"), TEXT("bdaiface.h"), TEXT("")),
    CInterfaceInfo(TEXT("{EF30F379-985B-4D10-B640-A79D5E04E1E0}"), TEXT("IBDA_DigitalDemodulator"), TEXT("bdaiface.h"), TEXT("")),
    CInterfaceInfo(TEXT("{71985F43-1CA1-11D3-9CC8-00C04F7971E0}"), TEXT("IBDA_EthernetFilter"), TEXT("bdaiface.h"), TEXT("")),
    CInterfaceInfo(TEXT("{71985F47-1CA1-11D3-9CC8-00C04F7971E0}"), TEXT("IBDA_FrequencyFilter"), TEXT("bdaiface.h"), TEXT("")),
    CInterfaceInfo(TEXT("{3F4DC8E2-4050-11D3-8F4B-00C04F7971E2}"), TEXT("IBDA_IPSinkControl"), TEXT("bdaiface.h"), TEXT("")),
    CInterfaceInfo(TEXT("{A750108F-492E-4D51-95F7-649B23FF7AD7}"), TEXT("IBDA_IPSinkInfo"), TEXT("bdaiface.h"), TEXT("")),
    CInterfaceInfo(TEXT("{71985F44-1CA1-11D3-9CC8-00C04F7971E0}"), TEXT("IBDA_IPV4Filter"), TEXT("bdaiface.h"), TEXT("")),
    CInterfaceInfo(TEXT("{E1785A74-2A23-4FB3-9245-A8F88017EF33}"), TEXT("IBDA_IPV6Filter"), TEXT("bdaiface.h"), TEXT("")),
    CInterfaceInfo(TEXT("{992CF102-49F9-4719-A664-C4F23E2408F4}"), TEXT("IBDA_LNBInfo"), TEXT("bdaiface.h"), TEXT("")),
    CInterfaceInfo(TEXT("{D2F1644B-B409-11D2-BC69-00A0C9EE9E16}"), TEXT("IBDA_SignalProperties"), TEXT("bdaiface.h"), TEXT("")),
    CInterfaceInfo(TEXT("{1347D106-CF3A-428A-A5CB-AC0D9A2A4338}"), TEXT("IBDA_SignalStatistics"), TEXT("bdaiface.h"), TEXT("")),
    CInterfaceInfo(TEXT("{79B56888-7FEA-4690-B45D-38FD3C7849BE}"), TEXT("IBDA_Topology"), TEXT("bdaiface.h"), TEXT("")),
